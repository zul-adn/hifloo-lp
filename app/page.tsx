      ...
      <section className="relative pt-28 pb-20 sm:pb-28 overflow-hidden ">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
          <div className="flex flex-col items-center">
            ...
            <AnimateOnScroll
              animation="fadeInUp"
              className="w-full max-w-2xl mx-auto text-center lg:text-center"
            >
          ...
          <div className="space-y-3">
            {[
              ...
              >
                ...
                >
                  <span
                    className={`text-sm font-semibold leading-snug transition-colors ${activeFaq === i ? "text-blue-600" : "text-slate-900 group-hover:text-blue-600"}`}
                  >
                    {faq.q}
                  </span>
                  <span
                    className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 mt-0.5 transition-all duration-200 ${activeFaq === i ? "bg-blue-600 rotate-180" : "bg-slate-100 group-hover:bg-blue-50"}`}
                  >
                    <ChevronRight
